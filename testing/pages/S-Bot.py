...
SERVER_URL_ASK = "http://127.0.0.1:3000/search"
...
url = st.text_area(
    label="Proporciona contexto a T-Bot mediante una URL",
    value = "",
    key="context")
...
def ask_user():
    ...
    if user_prompt:
        ...
        response = requests.post(
            SERVER_URL_ASK,
            json={"user_prompt": user_prompt, "url":url, "system_prompt":system_prompt, "max_new_tokens":max_new_tokens, "repetition_penalty":repetition_penalty, "temperature":temperature, "chunk_size":chunk_size, "chunk_overlap":chunk_overlap}
        )
